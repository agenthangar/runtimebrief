...
- Share Revyl viewer URLs as clickable links. The CLI opens the viewer locally; do not open a browser for it yourself. Inspect other local app URLs, screenshots, and reports with the available browser or image tools.
